...
<div class="little-float little-right">
    <form name="guestForm" method="post" action="${pageContext.request.contextPath}/controller">
        ...
        <input class="menu-submit" type="submit" value="<fmt:message key="button.showguests"/>"/>
    </form>
    ...
    <form name="adminForm" method="post" action="${pageContext.request.contextPath}/controller">
        ...
        <input class="menu-submit" type="submit" value="<fmt:message key="button.showadmines"/>"/>
    </form>
    ...
    <form name="clientForm" method="post" action="${pageContext.request.contextPath}/controller">
        ...
        <input class="menu-submit" type="submit" value="<fmt:message key="button.showclients"/>"/>
    </form>
    ...
    <form name="cleanerForm" method="post" action="${pageContext.request.contextPath}/controller">
        ...
        <input class="menu-submit" type="submit" value="<fmt:message key="button.showcleaners"/>"/>
    </form>
    ...
    <form name="serviceForm" method="post" action="${pageContext.request.contextPath}/controller">
        ...
        <input class="menu-submit" type="submit" value="<fmt:message key="button.showservices"/>"/>
    </form>

    <div class="little-float little-margin-left">${emptyList}</div>
    ${wrongAction}
    ${nullPage}
    <br/><ctg:remove-attr/>
</div>
