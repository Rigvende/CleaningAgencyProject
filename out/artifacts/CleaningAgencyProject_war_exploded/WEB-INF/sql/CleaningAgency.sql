...
CREATE TABLE IF NOT EXISTS `cleaning_agency`.`cleaners` (
  ...
  `commission` DECIMAL(3,2) NULL DEFAULT '0.00',
...
CREATE TABLE IF NOT EXISTS `cleaning_agency`.`orders` (
  ...
  `order_status` ENUM('registered', 'in process', 'done', 'declined', 'extended') CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_0900_ai_ci' NULL DEFAULT 'registered',
