...
public enum Statements {
    ...
    SQL_SELECT_CLEANER_BY_ID("SELECT id_cleaner, id_user, commission, notes AS cleaner_notes " +
    ...
    SQL_FIND_ORDERS_BY_CLIENT("SELECT users.id_user, users.login, users.password, users.role, users.name, " +
                    "users.lastname, users.phone, users.address, users.email, clients.id_client, " +
                    "clients.id_user, clients.discount, clients.location, clients.relative, " +
                    "clients.notes AS client_notes, cleaners.id_cleaner, cleaners.id_user, cleaners.commission, " +
                    "cleaners.notes AS cleaner_notes, orders.id_order, orders.order_time, orders.deadline, " +
                    "orders.order_status, orders.mark, orders.id_client, orders.id_cleaner " +
    ...
    SQL_FIND_ORDERS_BY_CLEANER("SELECT users.id_user, users.login, users.password, users.role, users.name, " +
                    "users.lastname, users.phone, users.address, users.email, clients.id_client, " +
                    "clients.id_user, clients.discount, clients.location, clients.relative, " +
                    "clients.notes AS client_notes, cleaners.id_cleaner, cleaners.id_user, cleaners.commission, " +
                    "cleaners.notes AS cleaner_notes, orders.id_order, orders.order_time, orders.deadline, " +
